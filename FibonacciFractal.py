...
def setup_pen_to_initial_position_and_set_color_to_red(render_zoom_factor):
    turtle_pen.penup()
...
def calculate_fibo(square_a_size_side, square_b_size_side):
...
def draw_square(render_zoom_factor, square_a_size_side, square_b_size_side):
